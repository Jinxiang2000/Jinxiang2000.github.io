...
## Education
{{< timeline >}}
{{% event title="M.S. in Industrial and Operations Engineering" company="University of Michigan, Ann Arbor" location="Ann Arbor, MI" from="Aug 2023" to="May 2025" %}}
...
{{% event title="Graduate Certificate in Data Science" company="University of Michigan, Ann Arbor" location="Ann Arbor, MI" from="Aug 2023" to="May 2025" %}}
- Database Systems & Application Design
- Information Retrieval
- Spatial Analysis
{{% /event %}}

{{% event title="B.S. in Statistics and Data Science" company="University of California, Santa Barbara" location="Santa Barbara, CA" from="Sep 2019" to="Jun 2023"  %}}
- R Programming, SAS Programming, Python Programming
-Probability Theory, Regression Analysis, Bayesian Data Analysis, Non-parametric Statistics, Experimental Design
...
{{% event title="B.A. in Mathematics" company="University of California, Santa Barbara" location="Santa Barbara, CA" from="Sep 2019" to="Jun 2023"  %}}
...
{{% event title="Data Management Consultant" company="Westland Management Solution" location="San Francisco, CA" from="Aug 2024" %}}
...
{{% event title="Process Improvement Consultant" company="Michigan Medicine" location="Ann Arbor, MI" from="Aug 2024" to="Dec 2024" %}}
...
- Proposed a hybrid flow shop scheduling model to optimize the chemotherapy preparation workflow, integrating the newly introduced ultrasound sonication step that operates concurrently with other tasks, reducing makespan and bottlenecks while enhancing sterile compounding accuracy by 5–10%
{{% /event %}}

{{% event title="Engineering Design Trainee → Intern Lead" company="San Francisco Public Utilities Commission" location="San Francisco, CA" from="Jun 2022" to="Aug 2024"  %}}
...
- **Workforce Planning Tool**: Built a Python–Django forecasting tool that visualized staff availability and workload projections 12 weeks ahead, helping Project Managers reduce last-minute reassignments and improve planning accuracy
...
{{% event title="Data Analyst" company="GoGaucho" location="Santa Barbara, CA" from="Feb 2022" to="Jun 2023" %}}
...
{{% event title="Research Data Assistant" company="Data, Research, Exploration, Access & Methods (DREAM) Lab, UCSB Library" location="Santa Barbara, CA" from="Sep 2021" to="Jun 2023"  %}}
...
- **Dianping Web Scraper** Engineered large-scale web crawler to collect children’s library data from 2000+ Chinese cities; automated CAPTCHA bypass and structured HTML parsing into clean CSV datasets.
{{% /event %}}
...
{{% event title="Student Researcher" company="SOCR Lab" location="University of Michigan" from="Jan 2024"  to="Dec 2024"%}}
...
{{% event title="Undergraduate Research Assistant" company="Social Perception Lab" location="University of California, Santa Barbara" from="Feb 2022"  to="Dec 2022"%}}
